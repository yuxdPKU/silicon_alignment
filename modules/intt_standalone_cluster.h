...
//  -*- C++ -*-.
#ifndef INTTSTANDALONECLUSTER_H
#define INTTSTANDALONECLUSTER_H
...
class intt_standalone_cluster : public SubsysReco
{
 public:

  intt_standalone_cluster(const std::string &name = "intt_standalone_cluster");

  ~intt_standalone_cluster() override;
 ...
 private:
  ...
  InttEventInfov1* intt_event_header = nullptr;
  InttRawHitContainerv2* inttcont = nullptr;
